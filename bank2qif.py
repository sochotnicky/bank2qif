...
def translate_headline(line):
    ...
    for headline_item in headline_items:
        translated_headline.append(translation.get(headline_item, headline_item))
    return ';'.join(translated_headline)


def dirty_csv_iterator(file):
